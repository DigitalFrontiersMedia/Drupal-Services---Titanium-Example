...
// in simulator we redefine to format for dsts Developer console
...
{\
	NSString * exceptionName = [@"org.dsts." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dsts";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIdstsNativeItemNone = -1, 
	UIdstsNativeItemSpinner = -2,
	UIdstsNativeItemProgressBar = -3,
	
	UIdstsNativeItemSlider = -4,
	UIdstsNativeItemSwitch = -5,
	UIdstsNativeItemMultiButton = -6,
	UIdstsNativeItemSegmented = -7,
	
	UIdstsNativeItemTextView = -8,
	UIdstsNativeItemTextField = -9,
	UIdstsNativeItemSearchBar = -10,
	
	UIdstsNativeItemPicker = -11,
	UIdstsNativeItemDatePicker = -12,
	
	UIdstsNativeItemInfoLight = -13,
	UIdstsNativeItemInfoDark = -14,
	
	UIdstsNativeItemDisclosure = -15,
	
	UIdstsNativeItemContactAdd = -16
};
