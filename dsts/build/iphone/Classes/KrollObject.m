 ...
 * Copyright (c) 2009-2011 by dsts, Inc. All Rights Reserved.
...
//@interface dstsObject : NSObject
//@end

@interface dstsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[dstsObject class]])
		{
			for (NSString *key in [[(dstsObject*)o modules] allKeys])
			{
